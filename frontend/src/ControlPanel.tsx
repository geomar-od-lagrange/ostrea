...
export default function ControlPanel({
  ...
  return (
    ...
    <div className="control-panel-legal">
      <div>Map: © <a href="https://openfreemap.org" target="_blank" rel="noopener noreferrer">OpenFreeMap</a></div>
      <div>© <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener noreferrer">OpenStreetMap</a> contributors</div>
