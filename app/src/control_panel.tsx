...
export default function ControlPanel(
  {setControlPanelSlider, setControlPanelRadioButtonDays, setControlPanelRadioButtonDepth, setControlPanelCheckBox}
    ...
    function handleRadioButtonsDays(e) {
      ...
      setRadioButtonDays(newValue);
      setControlPanelRadioButtonDays(newValue);
    }

    function handleRadioButtonsDepth(e) {
      const newValue = e.target.value;
      setRadioButtonDepth(newValue);
      setControlPanelRadioButtonDepth(newValue);
    }
  
    function handleSlider(e) {
      const newValue = e.target.value;
      setSlider(newValue);
      setControlPanelSlider(newValue);
    ...
    function handleCheckBox(e) {
      ...
      setControlPanelCheckBox(newValue);
    };
